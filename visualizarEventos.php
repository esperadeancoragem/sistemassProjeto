...
<!-- InstanceBeginEditable name="EditRegion" --><div class="form"><form method="post" name="visualizarEvento" id="visualizarEvento" accept-charset="UTF-8">
  <h2>Visualizador de Eventos</h2>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <h4><strong>Data(s) Selecionada(s):</strong></h4>
  <p>&nbsp;</p>
  <div align="center">
    <table width="1200" border="1" cellpadding="0" cellspacing="0" class="tbody">
      <tr>
        <th width="126" bgcolor="#CCCCCC"><div align="center">
          <h3>Data</h3>
        </div></th>
        <th width="200" bgcolor="#CCCCCC"><div align="center">
          <h3>Colaborador</h3>
        </div></th>
        <th width="143" bgcolor="#CCCCCC"><div align="center">
          <h3>Setor</h3>
        </div></th>
        <th width="300" bgcolor="#CCCCCC"><div align="center">
          <h3>Local</h3>
        </div></th>
        <th width="198" bgcolor="#CCCCCC"><div align="center">
          <h3>Assunto</h3>
        </div></th>
