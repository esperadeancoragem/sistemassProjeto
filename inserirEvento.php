...
<!-- InstanceBeginEditable name="EditRegion" --><div class="form"><form method="post" name="inserirEvento" id="inserirEvento" accept-charset="UTF-8">
  <h2>Inserir Evento</h2>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <h5>Data Selecionada xx/xx/xxx</h5>
  <p>&nbsp;</p>
  <h5>Horário início 
    <label for="horaInicio"></label>
    <input name="horaInicio" type="text" class="textbox" id="horaInicio" size="4" required>
  Horário termino 
    <label for="horarioTermino"></label>
    <input name="horarioTermino" type="text" class="textbox" id="horarioTermino" size="4" required>
  </h5>
  <p>&nbsp;</p>
  <h5>Setor
    <label for="setor"></label>
    <select name="setor" class="textbox" id="setor">
      <option>SELECIONE</option>
    </select>
  Assunto 
    <label for="assuntoEvento"></label>
    <select name="assuntoEvento" class="textbox" id="assuntoEvento">
      <option>SELECIONE</option>
    </select> 
    </h5>
  <h5>&nbsp;</h5>
  <h5>Local 
    ...
    <input name="local" type="text" class="textbox" id="local" size="80" required>
  </h5>
  <p>&nbsp;</p>
  <h4>Observações</h4>
  <p>&nbsp;</p>
  <p>
    <label for="obs"></label>
    <textarea name="obs" cols="55" rows="6" class="textarea" id="obs" required></textarea>
  </p>
  <p>&nbsp;</p>
  <p>
    <input name="button" type="submit" class="botao" id="button" value="Cadastrar">
