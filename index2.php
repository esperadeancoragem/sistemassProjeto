...
//$nome = 'teste2';
//$busca = 'teste';
//var_dump(EditTarefComuns($nome, $busca));
...
var_dump(DBUpdataTarefComuns('tarefascomuns', $dados, 'idTarefaComum = 12'));
...
//Seleciona
$tarefascomuns = DBSelTarefasComuns('tarefascomuns', null, '*');
foreach ($tarefascomuns as $tComuns){
	echo $tComuns['Titulo'].'<br>';
}
...
<form method="post" name="form1" id="form1" autocomplete="on" accept-charset="UTF-8">
  ...
  <p>
    ...
    <input name="Titulo" type="text" required id="Titulo" size="100">
</p>
  <p>
  ...
  <p>
    <label for="textfield3">Custo:</label>
