...
<div class="form">
<form method="post" name="gerenciaAcesso" id="gerenciaAcesso" 
accept-charset="UTF-8">
    
    <h2>Área de Gerencia</h2>
    <h6 class="vermelho">Apenas pessoas autorizadas</h6>
    <p class="vermelho">&nbsp;</p>
    <p class="vermelho">&nbsp;</p>
    <h4>Digite seu ID 
      <label for="id"></label>
      <input name="id" type="text" class="textbox" id="id" size="6" maxlength="6">
    Título 
    <label for="titulo"></label>
    <select name="titulo" class="textbox" id="titulo">
    </select>
