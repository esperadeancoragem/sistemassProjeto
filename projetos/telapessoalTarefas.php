...
<div class="form"><form method="post" name="telapessoalTarefas" id="telapessoalTarefas" 
accept-charset="UTF-8">
  ...
  <div align="center">
    <table width="1200" border="1" cellpadding="0" cellspacing="0" class="tbody">
      ...
      <tr>
        <td colspan="7" bgcolor="#CCCCCC"><div align="left">
          <input name="radio" type="radio" id="selecione" value="selecione">
          <input name="selecione" type="submit" class="botao" id="selecione2" value="Selecione">
        </div>
          <label for="selecione"></label>        <label for="selecione">
            <div align="left"></div>
          </label></td>
        </tr>
    </table>
