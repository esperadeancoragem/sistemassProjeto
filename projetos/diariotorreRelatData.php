...
<div class="form"><form method="post" name="diariotorreRelat" id="diariotorreRelat" accept-charset="UTF-8">
  ...
  <h4 align="center">De 
    ...
    <input name="dataInicio" type="text" class="textbox" id="dataInicio" size="10">
    até 
    <label for="dataFim"></label>
  <input name="dataFim" type="text" class="textbox" id="dataFim" size="10">
  ...
  <div align="center">
    <table width="1200" border="1" cellpadding="0" cellspacing="0" class="tbody">
      <tr>
        <th width="200" bgcolor="#CCCCCC"><div align="center">Data</div></th>
