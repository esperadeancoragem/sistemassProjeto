...
<!-- InstanceBeginEditable name="EditRegion" -->
  <div class="form">
    <form method="post" name="graficoProducao" id="graficoProducao" accept-charset="UTF-8">
      ...
      <table width="730" border="1" cellspacing="0" class="tbody">
        ...
        <tr>
          <td width="100"><h4 align="center">
            <label for="dataInicioA"></label>
            <input name="dataInicioA" type="text" class="textbox" id="dataInicioA" size="14">
          </h4></td>
          <td width="100"><h4 align="center">
            <label for="dataFimA"></label>
            <input name="dataFimA" type="text" class="textbox" id="dataFimA" size="14">
          </h4></td>
          <td width="100"><h4 align="center">
            <label for="dataInicioB"></label>
            <input name="dataInicioB" type="text" class="textbox" id="dataInicioB" size="14">
          </h4></td>
          <td width="100"><h4 align="center">
            <label for="dataFimB"></label>
            <input name="dataFimB" type="text" class="textbox" id="dataFimB" size="14">
          </h4></td>
          <td width="100"><h4 align="center">
            <label for="dataInicioC"></label>
            <input name="dataInicioC" type="text" class="textbox" id="dataInicioC" size="14">
          </h4></td>
          <td width="100"><h4 align="center">
            <input name="dataFimC" type="text" class="textbox" id="dataFimC" size="14">
          </h4></td>
        </tr>
        <tr>
          <td width="100"><h4>Atribuição</h4></td>
          <td colspan="2"><h4>
            <label for="atribuicao"></label>
            <select name="atribuicao" class="textbox" id="atribuicao">
            </select>
          </h4></td>
          <td width="100"><h4>Sub-atribuição</h4></td>
          <td colspan="2"><h4>
            <select name="subatribuicao" class="textbox" id="subatribuicao">
            </select>
          </h4></td>
        </tr>
        <tr>
      ...
      <p>&nbsp;</p>
      <p>
        <input name="calcular" type="submit" class="botao" id="calcular" value="Calcular">
      </p>
      <p>&nbsp;</p>
      <h4 align="left">Período A =</h4>
      <h4 align="left">Período B =</h4>
      <h4 align="left">Período C =</h4>
      <p>&nbsp;</p>
      <p>
        <input name="criarGrafico" type="submit" class="botao" id="criarGrafico" value="Criar Gráfico">
      </p>
      <p>&nbsp; </p>
