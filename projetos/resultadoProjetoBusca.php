...
<div class="form"><form method="post" name=""resultadoProjetoBusca"" id="resultadoProjetoBusca" accept-charset="UTF-8">
  ...
  <div align="center">
    <table width="800" border="0" cellpadding="0" cellspacing="5">
      <tr>
        <td width="160"><h4 align="center">Resultado de Projetos</h4></td>
        <td width="400"><label for="projetos"></label>
          <div align="center">
            <select name="projetos" class="textbox" id="projetos">
              </select>
          </div></td>
        <td width="100"><div align="center">
          <input name="visualizarProjeto" type="submit" class="botao" id="visualizarProjeto" value="Visualizar">
          </div></td>
      ...
      <tr>
        <td width="160"><h4 align="center">Resultado de Construtoras</h4></td>
        <td width="400"><label for="construtoras"></label>
          <div align="center">
            <select name="construtoras" class="textbox" id="construtoras">
              </select>
          </div></td>
        <td width="100"><div align="center">
          <input name="visualizarConstrutora" type="submit" class="botao" id="visualizarConstrutora" value="Visualizar">
          </div></td>
        </tr>
    </table>
  </div>
