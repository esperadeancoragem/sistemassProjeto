...
<!-- InstanceBeginEditable name="EditRegion" --><div class="form"><form method="post" name="telapessoalTarefas" id="telapessoalTarefas" 
accept-charset="UTF-8">
  
  <h2>Relatório de Projetos</h2>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <h6 class="vermelho">- Projetos Executivos para iniciar</h6>
  <h6></h6>
  <h4>&nbsp;</h4>
  <p>&nbsp;</p>
  <h4>Usuário</h4>
  ...
  <table width="1250" border="1" cellpadding="0" cellspacing="0" class="tbody">
    <tr>
      ...
      <th width="150" bgcolor="#CCCCCC"><div align="center">
        <h5>Setor / Funcionário</h5>
      </div></th>
      <th width="100" bgcolor="#CCCCCC"><div align="center">
        <h5>Início - Conclusão</h5>
      </div></th>
    </tr>
    <tr>
      <td width="150">&nbsp;</td>
    ...
    <tr>
      <td colspan="6" bgcolor="#CCCCCC"><input type="radio" name="radio" id="selecione" value="selecione">
        <input name="selecione" type="submit" class="botao" id="selecione2" value="Selecione">
        <label for="selecione"></label></td>
    </tr>
  </table>
  <p>&nbsp;</p>
