...
<!-- InstanceBeginEditable name="EditRegion" -->
  <div class="form">
    <form method="post" name="gerenciaRelatorio" id="gerenciaRelatorio" 
accept-charset="UTF-8">
      ...
      <p>&nbsp;</p>
      <h4 class="vermelho">- Croquis / Projetos Executivos para vistoriar - Croquis para iniciar - Projetos Executivos para iniciar</h4><h4>&nbsp; </h4>
      <h4>Status
  <label for="status"></label>
        ...
        <input name="filtrar" type="submit" class="botao" id="filtrar" value="Filtrar">
      </h4>
      <p>&nbsp;</p>
      <div align="center">
        <table width="1250" border="1" cellpadding="0" cellspacing="0">
          <tr>
            <th width="150" bgcolor="#CCCCCC"><div align="center">
              <h5><span class="tbody">Projeto</span></h5>
            </div></th>
            <th width="150" bgcolor="#CCCCCC"><div align="center">
              <h5><span class="tbody">Tarefa</span></h5>
            </div></th>
            <th width="150" bgcolor="#CCCCCC"><div align="center">
              <h5><span class="tbody">Prioridade</span></h5>
            </div></th>
            <th width="150" bgcolor="#CCCCCC"><div align="center">
              <h5><span class="tbody">Status</span></h5>
            </div></th>
            <th width="150" bgcolor="#CCCCCC"><div align="center">
              <h5><span class="tbody">Setor / Funcionário</span></h5>
            </div></th>
            <th width="100" bgcolor="#CCCCCC"><div align="center">
              <h5><span class="tbody">Início - Conclusão</span></h5>
            </div></th>
          </tr>
          <tr>
            <td width="150">&nbsp;</td>
          ...
          <tr>
            <td colspan="6" bgcolor="#CCCCCC"><span class="tbody">
