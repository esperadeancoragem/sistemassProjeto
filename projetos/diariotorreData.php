...
<div class="form"><form method="post" name="diariotorreData" id="diariotorreData" accept-charset="UTF-8">
      
      <h2>Relatório Diário da Torre por Data</h2>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <h4>Data inicial
        <label for="data1"></label>
        <input name="data1" type="text" class="textbox" id="data1" size="10" maxlength="0">
        Data final
        <input name="data2" type="text" class="textbox" id="data2" size="10" maxlength="0">
