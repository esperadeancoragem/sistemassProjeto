...
" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><div align="center"><strong><a href="anterior"><img src="icones/anterior.png" alt="voltar" name="Anterior" width="24" height="24" id="Anterior" align="right"></a></strong></div></td>
      <td><h4 align="center">Maio 2016</h4></td>
      <td><div align="center"><a href="próximo"><img src="icones/proximo.png" alt="ir" name="Próximo" width="24" height="24" id="Próximo" align="left"></a></div></td>
      </tr>
  </table>
</div>
<p align="center">&nbsp;</p>
<div align="center">
  <table width="400" border="0" cellspacing="0" cellpadding="0">
    ...
    <table width="400" border="0" cellspacing="10" cellpadding="0">
      <tr>
        <td><h5 align="center">
          <input type="radio" name="dia#8" id="dia#8">
          01</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#9" id="dia#9">
          02</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#10" id="dia#10">
          03</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#11" id="dia#11">
          04</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#12" id="dia#12">
          05</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#13" id="dia#13">
          06</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#14" id="dia#14">
          07</h5></td>
      </tr>
      <tr>
        <td><h5 align="center">
          <input type="radio" name="dia#15" id="dia#15">
          08</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#16" id="dia#16">
          09</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#17" id="dia#17">
          10</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#18" id="dia#18">
          11</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#19" id="dia#19">
          12</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#20" id="dia#20">
          13</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#21" id="dia#21">
          14</h5></td>
        </tr>
      <tr>
        <td><h5 align="center">
          <input type="radio" name="dia#22" id="dia#22">
          15</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#23" id="dia#23">
          16</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#24" id="dia#24">
          17</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#25" id="dia#25">
          18</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#26" id="dia#26">
          19</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#27" id="dia#27">
          20</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#28" id="dia#28">
          21</h5></td>
        </tr>
      <tr>
        <td><h5 align="center">
          <input type="radio" name="dia#29" id="dia#29">
          22</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#30" id="dia#30">
          23</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#31" id="dia#31">
          24</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#32" id="dia#32">
          25</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#33" id="dia#33">
          26</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#34" id="dia#34">
          27</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#35" id="dia#35">
          28</h5></td>
        </tr>
      <tr>
        <td><h5 align="center">
          <input type="radio" name="dia#36" id="dia#36">
          29</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#37" id="dia#37">
          30</h5></td>
        <td><h5 align="center">
          <input type="radio" name="dia#38" id="dia#38">
          31</h5></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
...
<p align="center">&nbsp;</p>
<p align="center">
  <input name="Inserir Evento" type="submit" class="botao" id="Inserir Evento" value="Inserir">
  <input name="Inserir Evento2" type="submit" class="botao" id="Inserir Evento2" value="Visualizar">
  <input type="reset" name="Inserir Evento3" id="Inserir Evento3" class="botao" value="Limpar">
</p>
<p>&nbsp;</p>
