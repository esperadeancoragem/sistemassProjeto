...
if ($libera == 'post'){
	$dados = array(
	'Titulo' => $_POST['projeto'],
	'Prioridade' => $_POST['construtoras'],
	'Custo' => $_POST['Custo']
	);
	$grava = CreateProjetos('projetos', $dados);
...
$construtoras = DBSelConstrutoras('construtoras', null, '*');
...
<div class="form"><form method="post" name="projetoCadastro" id="projetoCadastro" accept-charset="UTF-8">
  ...
  <table width="650" border="0" cellpadding="0" cellspacing="5">
    <tr>
      ...
      <td colspan="3"><input name="projeto" type="text" class="textbox" id="projeto" size="90"></td>
    </tr>
    <tr>
      <td width="80"><h4>Construtora</h4></td>
      <td width="120"><h4>
        <label for="construtora"></label>
    <select name="construtoras" required class="textbox" id="construtoras">
    <option>Selecione</option>
    <?php foreach ($construtoras as $constru){
	echo '<option value="'.$constru['idConstrutora'].'">'.$constru['nomeConstru'].'</option>';
}
?>
    </select>
      </h4></td>
