...
<?php
require('Connections/bdprojetos.php');
...
if ($libera == 'post'){
	...
	$grava = CreateTarefComuns('tarefascomuns', $dados);
...
//Seleciona Usuários
$users = DBSelUsers('usuarios', null, '*');


//Seleciona Prioriedades
$prioriedade = DBSelPrioriedades('prioriedades', null, '*');
...
<form method="post" name="form1" id="form1" accept-charset="UTF-8">
  <fieldset>
    <h1>
      <legend>Cadastro de Tarefas Comuns</legend>
2      
<p>&nbsp;</p>
    </h1>  
  <p>
    <label for="CustoemDias">Titulo:</label>
    <input name="Titulo" type="text" autofocus required class="textbox" id="Titulo" onkeyup="up(this)" size="100">
</p>
  <p>&nbsp;</p>
  <p>
    <label for="Atribuido">Prioridade:</label>
    <select name="Prioridade" required class="textbox" id="Prioridade">
    <option>Selecione</option>
    <?php foreach ($prioriedade as $priori){
	echo '<option value="'.$priori['idPrioriedade'].'">'.$priori['Prioriedade'].'</option>';
}
?>
    </select>
  </p>
  ...
  <p>
    ...
    <input name="Custo" type="text" required class="textbox" id="Custo">
    <label for="CustoemDias">CustoemDias:</label>
    <input name="CustoemDias" type="text" class="textbox" id="CustoemDias">
  </p>
  <p>&nbsp;</p>
  <p>
    <label for="Atribuido">Atribuido:</label>
    <select name="Atribuido" required class="textbox" id="Atribuido">
      <option>Selecione</option>
...
?>
  ...
  <p>
    ...
    <textarea name="Descricao" cols="100" rows="5" class="textarea" id="Descricao" placeholder="Descrição" onkeyup="up(this)"></textarea>
  </p>
  <p>&nbsp;</p>
  <p>
    <input name="submit" type="submit" class="botao" id="submit" value="Enviar"> 
    <input name="reset" type="reset" class="botao" id="reset" value="Redefinir">
