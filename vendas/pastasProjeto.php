...
<div class="form"><form method="post" name="pastasProjetos" id="pastasProjetos" 
accept-charset="UTF-8">
  ...
  <p>&nbsp;</p>
    ...
    <div align="center">
      <table width="1000" border="1" cellpadding="0" cellspacing="0" class="tbody">
        <tr>
          <th width="300" bgcolor="#CCCCCC"><h3>Pastas</h3></th>
          <th width="200" bgcolor="#CCCCCC"><h3>Data da última modificação</h3></th>
          <th width="100" bgcolor="#CCCCCC"><h3>Download</h3></th>
          </tr>
        <tr>
          <td width="300">&nbsp;</td>
          <td width="200">&nbsp;</td>
