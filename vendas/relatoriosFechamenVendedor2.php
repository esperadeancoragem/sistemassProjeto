...
<div class="form"><form method="post" name="relatoriosFechamenVendedor2" id="relatoriosFechamenVendedor2" accept-charset="UTF-8">
  
  <h2>Relatório de Fechamento por Vendedor</h2>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <h4>Vendedor: xx</h4>
  <p>&nbsp;</p>
  <h4>Total de registros encontrados: xx</h4>
  <p>&nbsp;</p>
  <div align="center">
    <table width="1200" border="1" align="center" cellpadding="0" cellspacing="0" class="tbody">
      <tr>
        <th width="50" bgcolor="#CCCCCC"><h3>ID</h3></th>
        <th width="300" bgcolor="#CCCCCC"><h3>Projeto</h3></th>
        <th width="120" bgcolor="#CCCCCC"><h3>Data Inclusão</h3></th>
        <th width="120" bgcolor="#CCCCCC"><h3>Data Fechamento</h3></th>
        <th width="50" bgcolor="#CCCCCC"><h3>Status</h3></th>
        <th width="200" bgcolor="#CCCCCC"><h3>Prioridade</h3></th>
        </tr>
      <tr>
        <td width="50">&nbsp;</td>
        <td width="300">&nbsp;</td>
