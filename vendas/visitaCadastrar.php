...
<div class="form"><form method="post" name="visitasCadastrar" id="visitasCadastrar" accept-charset="UTF-8">

  <h2>Cadastro de Visita</h2>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <h4>Visitas 
    <label for="selecionarVisita"></label>
    <select name="selecionarVisita" class="textbox" id="selecionarVisita">
    </select>
  </h4>
  <p>&nbsp;</p>
  <p>
