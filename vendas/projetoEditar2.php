...
<div class="form"><form method="post" name="projetoCadastro" id="projetoCadastro" accept-charset="UTF-8">
  ...
  <table width="1000" border="0" cellpadding="0" cellspacing="10" >
    <tr>
      ...
      <td colspan="5"><input name="projeto" type="text" class="textbox" id="projeto2" size="90"></td>
    </tr>
    <tr>
      <td><h4>Construtora</h4></td>
      <td width="300"><h4>
    ...
    <tr>
      ...
      <td width="60"><h4>Motivo</h4></td>
      <td width="200">        <select name="motivo" class="textbox" id="motivo">
      </select></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="300"><h4>
        <input name="ultVisita" type="text" class="textbox" id="ultVisita">
      </h4></td>
    ...
    <tr>
      ...
      <td width="300"><h4>
        <input name="torres" type="text" class="textbox" id="torres">
      </h4></td>
      <td width="80"><h4>Data de fechamento</h4></td>
      <td width="250">
        <h4>
          <input name="dataFechamento" type="text" class="textbox" id="dataFechamento">
    </h4></td>
      <td width="60">&nbsp;</td>
      <td width="200">&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td width="250"><h4>
        <input name="dataTermino" type="text" class="textbox" id="dataTermino">
      </h4></td>
      <td width="60">&nbsp;</td>
      <td width="200">&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td width="300"><h4>
        <input name="orcamentos" type="text" class="textbox" id="orcamentos">
      </h4></td>
      <td width="80"><h4>Tipos de Instalação</h4></td>
      <td width="250"><h5>
        <input type="checkbox" name="linhadevida" id="linhadevida">
        <label for="linhadevida">Linha de vida
          <input type="checkbox" name="espera" id="espera">
          </label>
        Espera
        <input type="checkbox" name="concretagem" id="concretagem">
        <label for="concretagem">Concretagem
           <input type="checkbox" name="pecas" id="pecas">
          Peças </label>
      </h5></td>
      <td width="60"><h4>&nbsp;</h4>      </td>
      <td width="200">&nbsp;</td>
    </tr>
    <tr>
      <td width="80"><h4>Qntd de Esperas</h4></td>
      <td width="300"><h4>
        <input name="qntdEsperas" type="text" class="textbox" id="qntdEsperas">
      </h4></td>
 ...
 <table width="340" border="0" cellpadding="0" cellspacing="10">
      <tr>
        <td width="74"><h4>
      ...
      <tr>
        <td width="74"><h4>Bairro</h4></td>
        <td width="110"><label for="bairro"></label>
        <input name="bairro" type="text" class="textbox" id="bairro"></td>
        <td width="20"><h4>CEP</h4></td>
        <td width="143"><label for="CEP"></label>
        <input name="CEP" type="text" class="textbox" id="CEP"></td>
      </tr>
      <tr>
        <td width="74"><h4>Cidade</h4></td>
        <td width="110"><label for="cidade"></label>
        <input name="cidade" type="text" class="textbox" id="cidade"></td>
        <td width="20"><h4>Estado</h4></td>
        <td width="143"><label for="UF"></label>
        <input name="UF" type="text" class="textbox" id="UF"></td>
      </tr>
  </table>
  </fieldset>
    <fieldset>
  ...
  <legend><h2>Anotações</h2></legend>
  <p>&nbsp; </p>
  <h4>Diretoria</h4>
        <p>
          <label for="anotacoesDiretoria"></label>
          <textarea name="anotacoesDiretoria" cols="100" rows="5" class="textarea" id="anotacoesDiretoria"></textarea>
        </p>
          <p>
          ...
          <p>
            <label for="anotacoesDiretoria"></label>
            <textarea name="anotacoesProjetos" cols="100" rows="5" class="textarea" id="anotacoesDiretoria"></textarea>
          </p>
        <p>&nbsp;</p>
        <h4>
          <label for="anotacoesDiretoria"></label>
        ...
        <p>
          <label for="anotacoesDiretoria"></label>
          <textarea name="anotacoesVendas" cols="100" rows="5" class="textarea" id="anotacoesDiretoria"></textarea>
        </p>
        <p>&nbsp;</p>
  <h4>Instalação</h4>
        <p>
  <label for="anotacoesInstalacao"></label>
          <textarea name="anotacoesInstalacao" cols="100" rows="5" class="textarea" id="anotacoesInstalacao"></textarea>
        </p>
        <p>&nbsp;</p>
  </fieldset>
        <fieldset>
            <legend><h2>Tarefas</h2></legend>
            <p>&nbsp;</p>
            <h3>Tarefas do Projeto</h3>
            <p>&nbsp;</p>
            <table width="700" border="1" cellpadding="0" cellspacing="0" class="tbody"  >
              <tr>
                <th width="80" bgcolor="#CCCCCC" ><h4 align="center">ID</h4></th>
                <th width="150" bgcolor="#CCCCCC"><h4 align="center">Tarefa</h4></th>
                <th width="150" bgcolor="#CCCCCC"><h4 align="center">Prioridade</h4></th>
                <th width="100" bgcolor="#CCCCCC"><h4 align="center">Status</h4></th>
              </tr>
              <tr>
                <td width="80">&nbsp;</td>
                <td width="150"><h5>04 - Orçamento</h5></td>
                <td width="150">&nbsp;</td>
                <td width="100">&nbsp;</td>
              </tr>
              <tr>
                <td width="80">&nbsp;</td>
                <td width="150"><h5>05 - Marcação dos pontos</h5></td>
                <td width="150">&nbsp;</td>
                <td width="100">&nbsp;</td>
              </tr>
              <tr>
                <td width="80">&nbsp;</td>
                <td width="150"><h5>06 - Furação/Chumbamento</h5></td>
                <td width="150">&nbsp;</td>
                <td width="100">&nbsp;</td>
              </tr>
              <tr>
                <td width="80">&nbsp;</td>
                <td width="150"><h5>07 - Teste de arrancamento</h5></td>
                <td width="150">&nbsp;</td>
                <td width="100">&nbsp;</td>
              </tr>
              <tr>
                <td width="80">&nbsp;</td>
                <td width="150"><h5>08 - Instalação de esperas</h5></td>
                <td width="150">&nbsp;</td>
                <td width="100">&nbsp;</td>
              </tr>
              <tr>
                <td width="80">&nbsp;</td>
                <td width="150"><h5>09 - Projeto executivo</h5></td>
                <td width="150">&nbsp;</td>
                <td width="100">&nbsp;</td>
              </tr>
              <tr>
                <td width="80">&nbsp;</td>
                <td width="150"><h5>10 - Entrega de documentos</h5></td>
                <td width="150">&nbsp;</td>
                <td width="100">&nbsp;</td>
              </tr>
            </table>
    ...
    <h4>
      <input name="Alterar" type="button" class="botao" id="Alterar" value="Alterar">
