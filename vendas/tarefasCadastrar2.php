...
<div class="form"><form method="post" name="tarefasIncluir2" id="tarefasIncluir2" accept-charset="UTF-8">
...
<div align="center">
  <table width="1250" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="150"><h4 align="center">Projeto</h4></td>
      <td width="186"><h4 align="center">Tarefa</h4></td>
      <td width="186"><h4 align="center">Prioridade</h4></td>
      <td width="250"><h4 align="center">Atribuição</h4></td>
      <td width="186"><h4 align="center">Setor</h4></td>
      <td width="250"><h4 align="center">Descrição</h4></td>
      <td width="134"><h3 align="center">&nbsp;</h3></td>
      </tr>
    <tr>
      <td width="150"><label for="projeto"></label>
        <div align="center">
          <input name="projeto" type="text" class="textbox" id="projeto">
          </div></td>
      <td><div align="center">
      ...
      <td width="250"><label for="descricao"></label>
        <div align="center">
          <textarea name="descricao" cols="40" rows="3" class="textarea" id="descricao"></textarea>
          </div></td>
      <td><input name="cadastrar" type="submit" class="botao" id="cadastrar" value="Cadastrar"></td>
      </tr>
  </table>
</div>
<p>&nbsp;</p>
