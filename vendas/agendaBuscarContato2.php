...
<!-- InstanceBeginEditable name="EditRegion" --><div class="form">
<form method="post" name="agendaBuscarContato2" id="agendaBuscarContato2" accept-charset="UTF-8">
  ...
  <div align="center">
    <table width="1200" border="1" cellpadding="0" cellspacing="0" class="tbody">
      <tr>
        <th width="318" bgcolor="#CCCCCC"><h4>Nome</h4></th>
        <th width="217" bgcolor="#CCCCCC"><h4>Função</h4></th>
        <th width="217" bgcolor="#CCCCCC"><h4>Telefone</h4></th>
        <th width="217" bgcolor="#CCCCCC"><h4>E-Mail</h4></th>
        <th width="219" bgcolor="#CCCCCC"><h4>ID</h4></th>
        </tr>
      <tr>
        <td>&nbsp;</td>
