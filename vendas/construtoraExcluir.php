...
<!-- InstanceBeginEditable name="EditRegion" --><div class="form"><form method="post" name="construtoraExcluir" id="construtoraExcluir" accept-charset="UTF-8">
  <h2>Excluir Construtoras/Parceiros</h2>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <h4>Nome 
    <label for="nomeConstrutora"></label>
    <select name="nomeConstrutora" class="textbox" id="nomeConstrutora">
      </select>
