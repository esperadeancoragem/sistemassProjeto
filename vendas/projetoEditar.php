...
<div class="form"><form method="post" name="projetoEditar" id="projetoEditar" accept-charset="UTF-8">
  
  <h2 align="center">Edição de Projeto</h2>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p align="center">
  <label for="listaprojeto"></label>
  <select name="listaprojeto" class="textbox" id="listaprojeto">
  </select>
