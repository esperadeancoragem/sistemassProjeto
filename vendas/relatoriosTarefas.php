...
<div class="form"><form method="post" name="visualizarVisita" id="visualizarVisita" accept-charset="UTF-8">
  
  <h2>Relatório de Tarefas</h2>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <div align="center">
    <table width="1250" border="1" cellpadding="1" cellspacing="0" class="tbody">
      <tr>
        <td width="300" bgcolor="#CCCCCC"><h5 align="center">Projeto</h5></td>
        <td width="150" bgcolor="#CCCCCC"><h5 align="center">Tarefa</h5></td>
        <td width="150" bgcolor="#CCCCCC"><h5 align="center">Prioridade</h5></td>
        <td width="100" bgcolor="#CCCCCC"><h5 align="center">Status</h5></td>
      ...
      <tr>
        ...
        <td width="150"><label for="tarefa"></label>
          <div align="center">
            <select name="tarefa" class="textbox" id="tarefa">
              </select>
          </div></td>
        <td width="150"><label for="prioridade"></label>
          <div align="center">
            <select name="prioridade" class="textbox" id="prioridade">
              </select>
          </div></td>
        <td width="100"><label for="status"></label>
          <div align="center">
            <select name="status" class="textbox" id="status">
              </select>
          </div></td>
        <td width="80"><label for="atribuido"></label>
          <div align="center">
            <input name="atribuido" type="text" class="textbox" id="atribuido">        
          </div>        <label for="atribuicao"></label></td>
        <td width="200"><label for="subatribuido"></label>
          <div align="center">
            <select name="subatribuido" class="textbox" id="subatribuido">
              </select>
          </div></td>
        <td width="80"><label for="setor"></label>
          <div align="center">
            <input name="setor" type="text" class="textbox" id="setor">
          </div></td>
        <td width="80"><label for="liberado"></label>
          <div align="center">
            <select name="liberado" class="textbox" id="liberado">
              </select>
          </div></td>
        </tr>
    </table>
  ...
  <p>&nbsp;</p>
  <h4 align="center">Com início entre 
    <label for="inicio"></label>
    <input name="inicio" type="text" class="textbox" id="inicio" size="14">
  até 
  <label for="termino"></label>
  <input name="termino" type="text" class="textbox" id="termino" size="14">
