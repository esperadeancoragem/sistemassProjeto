...
<div class="form"><form method="post" name="inicioVendas" id="inicioVendas" accept-charset="UTF-8">
  
  <h1 align="center">Início</h1>
  <p align="center">&nbsp;</p>
  <p align="center">&nbsp;</p>
  <h3 align="center">Seja bem-vindo(a)! (Usuário(a))</h3>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <h4 align="center">Digite o projeto desejado abaixo</h4>
  <p align="center">&nbsp;</p>
  <p align="center">
    <label for="projeto"></label>
    <input name="projeto" type="text" class="textbox" id="projeto" size="40">
