...
<div class="form"><form method="post" name="pastaCadastro" id="pastaCadastro" accept-charset="UTF-8">
  
  <h2>Criação de Pastas</h2>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <h4 align="center">Nome da pasta 
    <label for="nomePasta"></label>
    <select name="nomePasta" class="textbox" id="nomePasta">
      </select>
    <input name="criarPasta" type="submit" class="botao" id="criarPasta" value="Criar">
  </h4>
  <p>&nbsp;</p>
