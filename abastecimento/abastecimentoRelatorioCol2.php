...
<div class=form><form method="post" name="abastecimentoRelatorioCol2" id="abastecimentoRelatorioCol2" accept-charset="UTF-8">

   <h2 align="center">Relatório de abastecimento de <span class="vermelho">xx-xx-xxxx</span> até <span class="vermelho">xx-xx-xxxx</span></h2>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <div align="center">
    <table width="1200" border="1" cellspacing="0" cellpadding="0">
      <tr class="tbody">
        <th width="100" bgcolor="#CCCCCC"><p>Data</p></th>
        <th width="200" bgcolor="#CCCCCC"><p>Colaborador</p></th>
        <th width="150" bgcolor="#CCCCCC"><p> ID Veículo</p></th>
        <th width="200" bgcolor="#CCCCCC"><p>Qntd abastecida</p></th>
        <th width="200" bgcolor="#CCCCCC"><p>Setor</p></th>
        <th width="100" bgcolor="#CCCCCC"><p>Editar/Excluir</p></th>
        </tr>
      <tr>
        <th width="100">&nbsp;</th>
        <th width="200">&nbsp;</th>
        ...
        <th width="200">&nbsp;</th>
        <th width="200">&nbsp;</th>
        <th width="100"><img src="../icones/editar.png" alt="" width="30" height="30"> <img src="../icones/deletar.png" alt="" width="30" height="30"></th>
        </tr>
    </table>
  </div>
  <p>&nbsp;</p>
