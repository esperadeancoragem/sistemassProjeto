...
<div class=form>
    ...
    <form method="post" name="abastecimentoCadastro" id="abastecimentoCadastro" accept-charset="UTF-8">
      <h2>Cadastro de Abastecimento</h2>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <table width="650" border="0" cellspacing="8" cellpadding="0">
        <tr>
          <td width="150"><h5>Cupom Fiscal Nº</h5></td>
          <td width="127"><input name="cupom2" type="text" class="textbox" id="cupom2" size="8" required></td>
          <td width="120"><h5>&nbsp;</h5></td>
          <td width="148">&nbsp;</td>
        </tr>
        <tr>
          <td width="150"><h5>Data do abastecimento</h5></td>
          <td width="127"><input name="dataAbastecimento2" type="text" class="textbox" id="dataAbastecimento2" size="10" required onKeyPress="formatar(this,'##/##/####')"></td>
          <td width="120"><h5>Odômetro</h5></td>
          <td width="148"><input name="odometro2" type="text" class="textbox" id="odometro2" size="8" required></td>
        </tr>
        <tr>
          <td width="150"><h5>Colaborador</h5></td>
          <td width="127"><select name="colaborador2" class="textbox" id="colaborador2" required>
            <option selected="selected">SELECIONE</option>
            <option>ALEXSSANDRO BOTELHO DA SILVA</option>
          </select></td>
          <td width="120"><h5>Veículo</h5></td>
          <td width="148"><select name="veiculo2" class="textbox" id="veiculo2" required>
            <option>SELECIONE</option>
          </select></td>
        </tr>
        <tr>
          <td width="150"><h5>Qntd abastecida</h5></td>
          <td width="127"><input name="qntdAbastecimento2" type="text" required class="textbox" id="qntdAbastecimento" size="6"></td>
          <td width="120"><h5>Tipo do combustível</h5></td>
          <td width="148"><select name="tipoCombustivel2" class="textbox" id="tipoCombustivel" required>
            <option selected="selected">SELECIONE</option>
        ...
        <tr>
          <td width="150"><h5>Valor por litro</h5></td>
          <td width="127"><input name="valorLitro2" type="text" required class="textbox" id="valorLitro" size="4"></td>
          <td width="120"><h5>Valor total</h5></td>
          <td width="148"><input name="valorTotalAbast2" type="text" class="textbox" id="valorTotalAbast" size="6" required></td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>
        <input name="Salvar" type="submit" class="botao" id="Salvar" value="Salvar">
