...
<div class=form><form method="post" name="veiculoRelatorio" id="veiculoRelatorio" accept-charset="UTF-8">
      ...
      <h2 align="center">Relatório de veículos cadastrados</h2>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p align="center">
        <label for="veiculo"></label>
        <select name="veiculo" class="textbox" id="veiculo">
          <option selected="selected">SELECIONE O VEÍCULO</option>
          <option>TODOS</option>
          <option>GOL 25</option>
          <option>SMART 25</option>
          <option>STRADA 52</option>
          <option>STRADA 16</option>
          <option>S10 67</option>
          <option>S10 73</option>
          <option>TOWNER 80</option>
        </select>
