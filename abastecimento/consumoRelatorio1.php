...
<div class=form><form method="post" name="consumoRelatorio1" id="consumoRelatorio1" accept-charset="UTF-8">
  ...
  <h2 align="center">Relatório de consumo por veículo</h2>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <h4 align="center">Selecione o veículo 
    <label for="veiculo"></label>
    <label for="veiculo2"></label>
    <select name="veiculo" class="textbox" id="veiculo2">
    </select>
  </h4>
  <p align="center">&nbsp;</p>
  <h4 align="center">Período de 
    <label for="data"></label>
    <input name="data" type="text" class="textbox" id="data" size="11" maxlength="10">
    a
    <label for="data1"></label>
    <input name="data1" type="text" class="textbox" id="data1" size="11" maxlength="10"> 
