...
<div class=form><form method="post" name="consumoRelatorio1" id="consumoRelatorio1" accept-charset="UTF-8">

    <h2 align="center">Relatório de consumo por veículo de xx/xx/xxxx a xx/xx/xxxx - Total de registros xxxx</h2>
    <p align="center">&nbsp;</p>
    <p align="center">&nbsp; </p>
    <div align="center">
      <table width="1200" border="1" cellpadding="0" cellspacing="0" class="tbody">
      <tr>
        <th width="100" bgcolor="#CCCCCC"><h4 align="center">Data</h4></th>
        <th width="200" bgcolor="#CCCCCC"><h4 align="center">Colaborador</h4></th>
        <th width="100" bgcolor="#CCCCCC"><h4 align="center">Qntd abastecida</h4></th>
        <th width="150" bgcolor="#CCCCCC"><h4 align="center">Tipo combustível</h4></th>
        <th width="100" bgcolor="#CCCCCC"><h4 align="center">Valor litro R$</h4></th>
        <th width="100" bgcolor="#CCCCCC"><h4 align="center">Valor total R$</h4></th>
        </tr>
      <tr>
  ...
  <table width="300" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="250"><h5>Qntd Lts. abastecidos no período</h5></td>
      <td width="100"><h5>600,0000 Lts</h5></td>
    </tr>
    <tr>
      <td width="250"><h5>Média de valor por litro </h5></td>
      <td width="100"><div>
        <h5>R$ 3,849</h5>
      </div></td>
    </tr>
    <tr>
      <td width="250"><h5>Custo total do período</h5></td>
      <td width="100"><div>
        <h5>R$ 2309,40</h5>
      </div></td>
    </tr>
