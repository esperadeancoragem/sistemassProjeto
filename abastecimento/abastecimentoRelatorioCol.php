...
<div class=form><form method="post" name="abastecimentoRelatorioCol" id="abastecimentoRelatorioCol" accept-charset="UTF-8">
  
  <h2 align="center">Relatório de Abastecimento</h2>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <h4 align="center">Colaborador 
    <label for="colaborador2"></label>
    <select name="colaborador" class="textbox" id="colaborador2">
      </select>
    Veículo 
    <label for="veiculo"></label>
    <select name="veiculo" class="textbox" id="veiculo">
      </select>
    Combustível 
    <label for="combustivel"></label>
    <select name="combustivel" class="textbox" id="combustivel">
      </select>
  </h4>
  <p align="center">&nbsp;</p>
  <h4 align="center">Período de 
    <label for="dataInicio"></label>
    <input name="dataInicio" type="text" class="textbox" id="dataInicio" onkeypress="formatar(this,'##-##-####')" size="10">
    à
    <label for="dataFim"></label>
    <input name="dataFim" type="text" class="textbox" id="dataFim" onkeypress="formatar(this,'##-##-####')" size="10">
