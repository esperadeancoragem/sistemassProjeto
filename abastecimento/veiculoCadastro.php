...
<div class=form><form method="post" name="veiculoCadastro" id="veiculoCadastro" accept-charset="UTF-8">
  ...
  <h5>Proprietário 
    ...
    <select name="proprietario" class="textbox" id="proprietario" required="required">
  ...
  <h5>
    ...
    <select name="marca" class="textbox" id="marca2" required="required">
      <option>SELECIONE</option>
      
      </select>
    Modelo
  <label for="modelo"></label>
    <input name="modelo" type="text" class="textbox" id="modelo" size="40" required>
  </h5>
  <h4>&nbsp;</h4>
  <h5>Cor
    <label for="cor"></label>
    <select name="cor" class="textbox" id="cor"required="required">
      <option>SELECIONE</option>
      
      </select>
    Ano Fab
    <input name="anoFab" type="text" class="textbox" id="anoFab" size="4" maxlength="4" required>
    Ano Mod
    <input name="anomod" type="text" class="textbox" id="anomod" size="4" maxlength="4" required>
  </h5>
  <p>&nbsp; </p>
  <h5>
    Placa
    <label for="placa"></label>
    <input name="placa" type="text" class="textbox" id="placa" size="8" maxlength="8" required>
    Renavam
    <label for="renavam"></label>
    <input name="renavam" type="text" class="textbox" id="renavam" size="15" maxlength="10" required>
  </h5>
  <p>&nbsp; </p>
  <h5>
    Nº Chassi
    <label for="numChassi"></label>
    <input name="numChassi" type="text" class="textbox" id="numChassi" size="18" maxlength="17" required>
    Nº Motor
    <label for="numMotor"></label>
    <label for="numMotor2"></label>
    <input name="numMotor" type="text" class="textbox" id="numMotor2" size="15" maxlength="10" required>
  </h5>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>
