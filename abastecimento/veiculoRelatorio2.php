...
<div class=form><form method="post" name="veiculoRelatorio" id="veiculoRelatorio" accept-charset="UTF-8">
    
    <h2 align="center">Relatório de veículo(s) cadastrado(s) </h2>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
    <div align="center">
      <table width="1200" border="1" align="center" cellpadding="0" cellspacing="0" class="tbody">
        <tr>
          <th width="100" bgcolor="#CCCCCC"><h4>ID Veículo</h4></th>
          <th width="100" bgcolor="#CCCCCC"><h4>Placa</h4></th>
          <th width="200" bgcolor="#CCCCCC"><h4>Renavam</h4></th>
          <th width="200" bgcolor="#CCCCCC"><h4>Chassi</h4></th>
          <th width="200" bgcolor="#CCCCCC"><h4>Motor</h4></th>
          <th width="150" bgcolor="#CCCCCC"><h4>Ano Fab/Mod</h4></th>
          <th width="100" bgcolor="#CCCCCC"><h4>Cor</h4></th>
          <th width="100" bgcolor="#CCCCCC"><h4>Proprietário</h4></th>
          <th width="100" bgcolor="#CCCCCC"><h4>Editar/ Excluir</h4></th>
        </tr>
        <tr>
          ...
          <td width="100"><div align="center"></div></td>
          <td width="100"><div align="center"></div></td>
          <td width="100"><img src="../icones/editar.png" width="30" height="30">  <img src="../icones/deletar.png" width="30" height="30"></td>
        </tr>
      </table>
    </div>
    <p>&nbsp; </p>
